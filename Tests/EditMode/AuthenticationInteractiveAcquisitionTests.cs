...
{
    public sealed class AuthenticationInteractiveAcquisitionTests
    {
        [Test]
        public async Task EndpointProviderMapsDescriptorsAndReacquiresSession()
        {
            ...
            var provider = new AuthenticationEndpointProvider(
                apiClient,
                config);
            AuthenticationSession authentication =
                AuthenticationSession.CreateTransient();
            var inputValues = new AuthenticationInputValues(
                new[]
                {
        ...
        public void TransientEditorStateClearsSecretFieldsOnDispatch()
        {
            ...
            var state = new AuthenticationTransientInputState();
            state.SetValue("account", "test-account");
            state.SetValue("credential", "test-credential");

            AuthenticationInputValues dispatched =
