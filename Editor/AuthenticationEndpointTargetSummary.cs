...
{
    internal sealed class AuthenticationEndpointTargetSummary
    {
        private AuthenticationEndpointTargetSummary(
            AuthenticationEndpointLocation signIn,
            AuthenticationEndpointLocation tokenCheck)
        {
            SignIn = signIn;
            TokenCheck = tokenCheck;
        }

        internal AuthenticationEndpointLocation SignIn { get; }

        internal AuthenticationEndpointLocation TokenCheck { get; }
        ...
        internal static AuthenticationEndpointTargetSummary Create(
            string signInMethod,
            string signInEndpoint,
            string tokenCheckMethod,
            string tokenCheckEndpoint)
        {
            return new AuthenticationEndpointTargetSummary(
                AuthenticationEndpointLocation.Create(
                    signInMethod,
                    signInEndpoint),
                AuthenticationEndpointLocation.Create(
                    tokenCheckMethod,
    ...
    internal sealed class AuthenticationEndpointLocation
    {
        private AuthenticationEndpointLocation(
            string origin,
            string displayValue)
        {
        ...
        internal static AuthenticationEndpointLocation Create(
            string method,
            string endpointTemplate)
        {
            ...
            return new AuthenticationEndpointLocation(
                origin,
                displayValue);
        }
